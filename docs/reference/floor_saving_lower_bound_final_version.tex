...
\cite{HalberstamRoth1966,Bloom1194}. The same catalogue page records unrefereed
discussion-thread claims at the $n^{2-o(1)}$ scale; those claims are not used here
\cite{Bloom1194}. The present draft gives
a self-contained explicit lower bound at the $n^2/\log n$ scale, including the constant and the
second-order denominator below.
